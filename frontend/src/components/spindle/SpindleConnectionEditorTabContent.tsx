...
import type { ConnectionEditorTabState } from '@/store/slices/spindle-placement'
...
interface Props {
  tab: ConnectionEditorTabState
}

/** Reparents the extension-owned portal root into the active native tab body. */
export default function SpindleConnectionEditorTabContent({ tab }: Props) {
